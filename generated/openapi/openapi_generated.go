...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/srl-labs/clabernetes/apis/v1alpha1.Link":                  schema_srl_labs_clabernetes_apis_v1alpha1_Link(ref),
		"github.com/srl-labs/clabernetes/apis/v1alpha1.LinkEndpoint":          schema_srl_labs_clabernetes_apis_v1alpha1_LinkEndpoint(ref),
		"github.com/srl-labs/clabernetes/apis/v1alpha1.LinkList":              schema_srl_labs_clabernetes_apis_v1alpha1_LinkList(ref),
		"github.com/srl-labs/clabernetes/apis/v1alpha1.LinkSpec":              schema_srl_labs_clabernetes_apis_v1alpha1_LinkSpec(ref),
		"github.com/srl-labs/clabernetes/apis/v1alpha1.LinkStatus":            schema_srl_labs_clabernetes_apis_v1alpha1_LinkStatus(ref),
		"github.com/srl-labs/clabernetes/apis/v1alpha1.Node":                  schema_srl_labs_clabernetes_apis_v1alpha1_Node(ref),
		"github.com/srl-labs/clabernetes/apis/v1alpha1.NodeList":              schema_srl_labs_clabernetes_apis_v1alpha1_NodeList(ref),
		...
		"github.com/srl-labs/clabernetes/apis/v1alpha1.NodeSpec":              schema_srl_labs_clabernetes_apis_v1alpha1_NodeSpec(ref),
		"github.com/srl-labs/clabernetes/apis/v1alpha1.NodeStatus":            schema_srl_labs_clabernetes_apis_v1alpha1_NodeStatus(ref),
...
func schema_srl_labs_clabernetes_apis_v1alpha1_Link(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Link represents a single point-to-point link between two Topology nodes that live in different launcher pods -- i.e. a cross-pod link realized as a vxlan or slurpeeth tunnel. Links that are internal to a node group (nodes sharing one network namespace) are NOT represented as Link objects; they remain inside the owning Node's sub-topology.\n\nA Link is created and owned by the Topology controller as part of the decomposed (scalable) reconcile path; see docs/design/0001-scale-node-link-crds.md. Representing each link as its own object is what removes the per-topology Connectivity object as a scaling bottleneck.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/srl-labs/clabernetes/apis/v1alpha1.LinkSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/srl-labs/clabernetes/apis/v1alpha1.LinkStatus"),
						},
					},
				},
			},
...
func schema_srl_labs_clabernetes_apis_v1alpha1_LinkList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/srl-labs/clabernetes/apis/v1alpha1.Link"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/srl-labs/clabernetes/apis/v1alpha1.Link", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_srl_labs_clabernetes_apis_v1alpha1_LinkSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"topologyName": {
						SchemaProps: spec.SchemaProps{
							Description: "TopologyName is the name of the Topology that owns this Link.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"endpointA": {
						SchemaProps: spec.SchemaProps{
							Description: "EndpointA is one end of the link.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/srl-labs/clabernetes/apis/v1alpha1.LinkEndpoint"),
						},
					},
					"endpointB": {
						SchemaProps: spec.SchemaProps{
							Description: "EndpointB is the other end of the link. Its NodeName may be the containerlab \"host\" keyword for host links.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/srl-labs/clabernetes/apis/v1alpha1.LinkEndpoint"),
						},
					},
					"connectivity": {
						SchemaProps: spec.SchemaProps{
							Description: "Connectivity is the connectivity flavor (vxlan or slurpeeth) used to realize this link.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tunnelID": {
						SchemaProps: spec.SchemaProps{
							Description: "TunnelID is the vxlan VNI / slurpeeth segment id allocated to this link. It is assigned once by the owning Topology and is stable for the life of the Link -- renumbering a live link would tear down a working tunnel. A value of 0 means an id has not yet been allocated.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
		...
		Dependencies: []string{
			"github.com/srl-labs/clabernetes/apis/v1alpha1.LinkEndpoint"},
	}
}

func schema_srl_labs_clabernetes_apis_v1alpha1_LinkStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"ready": {
						SchemaProps: spec.SchemaProps{
							Description: "Ready indicates whether both endpoints of the link have established connectivity.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
...
func schema_srl_labs_clabernetes_apis_v1alpha1_Node(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Node represents a single containerlab node -- or a group of nodes that share a network namespace (for example a Nokia SR-SIM \"distributed\" node declared with network-mode: container:<name>) -- that belongs to a Topology. It carries that node's single-node containerlab \"sub-topology\" plus the per-node configuration needed to launch it.\n\nA Node is created and owned by the Topology controller as part of the decomposed (scalable) reconcile path; see docs/design/0001-scale-node-link-crds.md. Because every per-node piece of state lives in its own Node object (rather than in one ever-growing field on the Topology), a Topology can describe thousands of nodes without hitting the etcd object size limit.\n\nNOTE: the plural/CLI name for this resource (\"nodes\") overlaps with the core Kubernetes Node at the kubectl level -- the fully qualified group (clabernetes.containerlab.dev) keeps it unambiguous to the API server, and the \"clabnode\" short name is provided so operators can select it without ambiguity. The final plural/short name is pending maintainer ratification.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/srl-labs/clabernetes/apis/v1alpha1.NodeSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/srl-labs/clabernetes/apis/v1alpha1.NodeStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/srl-labs/clabernetes/apis/v1alpha1.NodeSpec", "github.com/srl-labs/clabernetes/apis/v1alpha1.NodeStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_srl_labs_clabernetes_apis_v1alpha1_NodeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/srl-labs/clabernetes/apis/v1alpha1.Node"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/srl-labs/clabernetes/apis/v1alpha1.Node", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_srl_labs_clabernetes_apis_v1alpha1_NodeSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeSpec is the spec for a Node resource.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"topologyName": {
						SchemaProps: spec.SchemaProps{
							Description: "TopologyName is the name of the Topology that owns this Node. It matches the owning Topology's name and is also recorded as a label for selection.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"nodeName": {
						SchemaProps: spec.SchemaProps{
							Description: "NodeName is the name of the (containerlab) node this resource represents. For a node group that shares a network namespace this is the name of the group's primary node.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"kind": {
						SchemaProps: spec.SchemaProps{
							Description: "Kind is the topology kind this node was derived from -- \"containerlab\" or \"kne\".",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"definition": {
						SchemaProps: spec.SchemaProps{
							Description: "Definition is the single-node containerlab sub-topology (YAML) for this node. This is exactly the content mounted into the launcher pod at /clabernetes/topo.clab.yaml today. Its size is bounded by the node's own configuration and link degree -- never by the size of the overall Topology -- which is what allows a Topology to scale to very large node counts.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"connectivity": {
						SchemaProps: spec.SchemaProps{
							Description: "Connectivity is the connectivity flavor (vxlan or slurpeeth) inherited from the owning Topology, recorded here so the Node can be reconciled independently.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"filesFromConfigMap": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "FilesFromConfigMap is the set of files mounted from ConfigMaps for this node -- this is how bind-mounted config files (for example an frr.conf, a daemons file, or a startup-config) reach the launcher. It is the per-node slice of the owning Topology's deployment.filesFromConfigMap. The file *contents* live in their own ConfigMap object(s); this field only references them, so even large per-node config sets never bloat the Node object.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"filesFromURL": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "FilesFromURL is the set of files (fetched from a URL) to mount for this node. This is the per-node slice of the owning Topology's deployment.filesFromURL. URLs are used for files that exceed the ConfigMap (~1MB) size limit.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
				...
				Required: []string{"topologyName", "nodeName", "kind", "definition"},
			},
		},
		Dependencies: []string{
			"github.com/srl-labs/clabernetes/apis/v1alpha1.FileFromConfigMap", "github.com/srl-labs/clabernetes/apis/v1alpha1.FileFromURL"},
	}
}

func schema_srl_labs_clabernetes_apis_v1alpha1_NodeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeStatus is the status for a Node resource.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"ready": {
						SchemaProps: spec.SchemaProps{
							Description: "Ready indicates whether this node has reported ready (via the launcher status probes).",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
					...
					"readiness": {
						SchemaProps: spec.SchemaProps{
							Description: "Readiness is the last reported readiness string for the node -- one of \"ready\", \"notready\", or \"unknown\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
