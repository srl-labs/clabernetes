...
func (c *topologies) UpdateStatus(
	ctx context.Context,
	topology *v1alpha1.Topology,
	opts v1.UpdateOptions,
) (result *v1alpha1.Topology, err error) {
...
func (c *topologies) DeleteCollection(
	ctx context.Context,
